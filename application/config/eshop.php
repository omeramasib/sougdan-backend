...
$config['system_modules'] = [
    ...
    'whatsapp-settings' => array('create', 'read', 'update', 'delete'),
...
$config['notification_modules'] = [
    'otp' => array('customer', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'place_order' => array('customer', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'seller_place_order' => array('seller', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'ticket_status' => array('customer', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'settle_cashback_discount' => array('customer', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'settle_seller_commission' => array('seller', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'customer_order_received' => array('customer', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'customer_order_processed' => array('customer', 'delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'delivery_boy_order_processed' => array('delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'customer_order_shipped' => array('customer', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    // 'delivery_boy_order_shipped' => array('delivery_boy','notification_via_sms','notification_via_mail','notification_via_whatsapp'),
    'customer_order_delivered' => array('customer', 'delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'customer_order_cancelled' => array('customer', 'delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'customer_order_returned' => array('customer', 'seller', 'delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'delivery_boy_return_order_assign' => array('delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'customer_order_returned_request_decline' => array('customer', 'delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'customer_order_returned_request_approved' => array('customer', 'delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'delivery_boy_order_deliver' => array('customer', 'delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'wallet_transaction' => array('customer', 'admin', 'seller', 'delivery_boy', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'bank_transfer_receipt_status' => array('customer', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
    'bank_transfer_proof' => array('customer', 'admin', 'seller', 'notification_via_sms', 'notification_via_mail', 'notification_via_whatsapp'),
];
